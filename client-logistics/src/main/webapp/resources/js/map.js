...
baidumap = {
    ...
    init: function (page_mapid, centerpoint, zoom) {
        baidumap.page_mapid = baidumap.errorcheck("isnull", page_mapid) ?page_mapid : "container" ;
        baidumap.centerpoint = baidumap.errorcheck("isnull", centerpoint) ? "" : centerpoint;
        baidumap.errorcheck("ok", "", baidumap.createMap); //加载地图
    },
    createMap: function () {
